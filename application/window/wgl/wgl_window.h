...
namespace natus_app
{
    namespace natus_win32
    {
        ...
        class NATUS_APPLICATION_API wgl_window : public decorator_window, public natus_gpx::iwindow
        {
            ...
            typedef natus_gpu::natus_driver::natus_gl::gl_driver_ptr_t gl_driver_ptr_t ;

            typedef natus_std::vector< natus_gpu::natus_gl::igl_api_ptr_t > support_drivers_t ;
            typedef natus_std::vector< wgl_context_ptr_t > support_contexts_t ;
        ...
        private:
            ...
            natus_gpu::natus_gl::gl_33_api_ptr_t _gl_api_ptr = nullptr ;
        ...
        public: // interface 
            ...
            virtual natus_app::result destroy( void_t ) ;
            ...
            virtual void_t send_toggle( natus_app::toggle_window_in_t ) ;
        ...
        protected:
            ...
            natus_app::result create_context( void_t ) ;
        };
        natunatus::applicationdef( wgl_window ) ;
    }    
}