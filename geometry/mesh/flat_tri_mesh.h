...
namespace natus
{
    namespace geometry
    {
        ...
        struct NATUS_GEOMETRY_API flat_tri_mesh : public imesh
        {
            natus_this_typedefs( flat_tri_mesh ) ;
        ...
        public: // if you know the type is a 3d mesh, use these shortcut functions
            ...
            natus::math::vec3f_t get_vertex_position_3d( size_t const i ) const noexcept ;
            natus::math::vec3f_t get_vertex_normal_3d( size_t const i ) const noexcept ;
            natus::math::vec2f_t get_vertex_texcoord( size_t const l, size_t const i ) const noexcept ;


        };
        natus_typedef( flat_tri_mesh ) ;
    }
}
