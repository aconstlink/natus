...
namespace natus
{
    namespace geometry
    {
        class NATUS_GEOMETRY_API polygon_mesh : public imesh
        {
            natus_this_typedefs( polygon_mesh ) ;
        ...
        public:
            ...
            natus::geometry::result flatten( tri_mesh_ref_t mesh_out ) const ;
