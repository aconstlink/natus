...
fractal_3d::objects_t fractal_3d::menger_sponge( fractal_object_cref_t parent ) 
{
    ...
    natus::math::vec3f_t const start_pos = 
        parent.pos - natus::math::vec3f_t(step) ;
    
    //////////////////////////////////////////////////////
    // left 8 cubes
    {
        natus::math::vec3f_t ls = start_pos ;

        //
        // front
        //
        {
            natus::math::vec3f_t pos = ls ;
...
fractal_3d::objects_t fractal_3d::sierpinski_tetra( fractal_object_cref_t parent ) 
{
    ...
    natus::math::vec3f_t start_pos = parent.pos ;
