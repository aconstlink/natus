...
natus::math::vec3f_t const positions[6] =
{

    // center
    natus::math::vec3f_t( 0.0f, 0.0f, 0.0f ),   // 0
    
    // right 
    natus::math::vec3f_t( 1.0f, 0.0f, 0.0f ),   // 1

    // center
    natus::math::vec3f_t( 0.0f, 0.0f, 0.0f ),   // 2

    // up
    natus::math::vec3f_t( 0.0f, 1.0f, 0.0f ),   // 3
    
    // center
    natus::math::vec3f_t( 0.0f, 0.0f, 0.0f ),   // 4

    // front
    natus::math::vec3f_t( 0.0f, 0.0f, 1.0f )   // 5
...
//*************************************************************************************
natus::geometry::result coord_frame::make( flat_line_mesh_ptr_t wptr, input_params_cref_t params_in ) 
{
    if( wptr == nullptr )
        return natus::geometry::invalid_argument ;

    natus::geometry::flat_line_mesh_ref_t awire = *wptr ;

    // positions
    {
        awire.position_format = natus::geometry::vector_component_format::xyz ;
