...
natus::math::vec3f_t const positions[8] =
{
    // front
    natus::math::vec3f_t( -0.5f, -0.5f, 0.5f ),   // 0
    natus::math::vec3f_t( -0.5f, 0.5f, 0.5f ),    // 1
    natus::math::vec3f_t( 0.5f, 0.5f, 0.5f ),     // 2
    natus::math::vec3f_t( 0.5f, -0.5f, 0.5f ),    // 3
    // back
    natus::math::vec3f_t( -0.5f, -0.5f, -0.5f ),    // 4
    natus::math::vec3f_t( -0.5f, 0.5f, -0.5f ),     // 5
    natus::math::vec3f_t( 0.5f, 0.5f, -0.5f ),      // 6
    natus::math::vec3f_t( 0.5f, -0.5f, -0.5f )      // 7
} ;
size_t const g_num_positions = 8 ;

/// one normal for each face
natus::math::vec3f_t normals[6] =
{
    natus::math::vec3f_t( 0.0f, 0.0f, 1.0f ),
    natus::math::vec3f_t( 0.0f, 1.0f, 0.0f ),
    natus::math::vec3f_t( 0.0f, 0.0f, -1.0f ),
    natus::math::vec3f_t( 0.0f, -1.0f, 0.0f ),
    natus::math::vec3f_t( -1.0f, 0.0f, 0.0f ),
    natus::math::vec3f_t( 1.0f, 0.0f, 0.0f )
} ;
size_t const g_num_normals = 6 ;

natus::math::vec2f_t tex_0[4] =
{
    natus::math::vec2f_t( 0.0f, 0.0f ), // bottom left
    natus::math::vec2f_t( 0.0f, 1.0f ), // top left
    natus::math::vec2f_t( 1.0f, 1.0f ), // top right
    natus::math::vec2f_t( 1.0f, 0.0f ) // bottom right
} ;
...
//*************************************************************************************
natus::geometry::result cube::make( polygon_mesh_ptr_t mesh_ptr, input_params_cref_t params_in ) 
{
    if( mesh_ptr == nullptr )
        return natus::geometry::invalid_argument ;
    ...
    // positions
    {
        amesh.position_format = natus::geometry::vector_component_format::xyz ;
    ...
    // normals
    {
        amesh.normal_format = natus::geometry::vector_component_format::xyz ;
    ...
    amesh.texcoord_format = natus::geometry::texcoord_component_format::uv ;
...
//*************************************************************************************
natus::geometry::result cube::make( tri_mesh_ptr_t mesh_ptr, input_params_cref_t params_in ) 
{
    if( mesh_ptr == nullptr )
        return natus::geometry::invalid_argument ;

    natus::geometry::tri_mesh_ref_t amesh = *mesh_ptr ;
...
//*************************************************************************************
natus::geometry::result cube::make( flat_line_mesh_ptr_t mesh_ptr, input_params_cref_t params_in )
{
    if( mesh_ptr == nullptr )
        return natus::geometry::invalid_argument ;

    natus::geometry::flat_line_mesh_ref_t amesh = *mesh_ptr ;
