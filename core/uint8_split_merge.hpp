...
namespace natus
{
    namespace core
    {
        ...
        /// Big endian
        /// from number to byte array => split number to byte chunks
        ...
        /// Big endian
        /// merge bytes chunks to number
        /// from number to byte array
        struct uint8_msb_merge
        {
            static uint16_t uint16( uint8_t const* from )
            {
            ...
            static uint32_t uint32( uint8_t const* from )
            {
            ...
            static uint64_t uint64( uint8_t const* from )
            {
