...
namespace natus
{
    namespace math
    {
        ...
        public:
            ...
            natus_typedefs( vector4b, vecb ) ;
            natus_typedefs( vector4b, vec4b ) ;
        ...
        natus_typedefs( vector4< char >, vec4c ) ;
        natus_typedefs( vector4< unsigned char >, vec4uc ) ;
        natus_typedefs( vector4< int >, vec4i ) ;
        natus_typedefs( vector4< float >, vec4f ) ;
        natus_typedefs( vector4< double >, vec4d ) ;
        natus_typedefs( vector4< uint_t >, vec4ui ) ;
        natus_typedefs( vector4< ushort_t>, vec4us ) ;
    }
}
