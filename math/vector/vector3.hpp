...
namespace natus 
{
    namespace math
    {
        ...
        class vector3
        {
            natus_this_typedefs( vector3< T > ) ;

        public:

            natus_typedefs( T, type ) ;
            natus_typedefs( vector2<T>, vec2 ) ;
            natus_typedefs( vector3<T>, vec3 ) ;
            natus_typedefs( vector4<T>, vec4 ) ;
            natus_typedefs( vector3b, vec3b ) ;
            natus_typedefs( quaternion3< T >, quat3 ) ;
        ...
        natus_typedefs( vector3<char_t>, vec3c ) ;
        natus_typedefs( vector3<uchar_t>, vec3uc ) ;
        natus_typedefs( vector3<int_t>, vec3i ) ;
        natus_typedefs( vector3<uint_t>, vec3ui ) ;
