...
namespace natus
{
    namespace math
    {
        ...
        class euler_angles
        {
            natus_this_typedefs( euler_angles<T> ) ;
            natus_typedefs( T, type ) ;

            natus_typedefs( natus::math::angle< T >, angle ) ;
            natus_typedefs( natus::math::vector3<angle_t>, angles ) ;
            natus_typedefs( natus::math::vector3<T>, vec3 ) ;
        ...
        public:
            ...
            {
                natus::math::vec2f_t alpha, beta, gamma ;
                ...
                // beta
                {
                    ...
                    beta = natus::math::vec2f_t( beta_1, beta_2 ) ;
                }
                ...
                // gamma
                {
                    ...
                    gamma = natus::math::vec2f_t( gamma_1, gamma_2 ) ;
                }
                ...
                // alpha
                {
                    ...
                    alpha = natus::math::vec2f_t( alpha_1, alpha_2 ) ;
                }
        ...
        natus_typedefs( euler_angles<float_t>, euler_anglesf ) ;
        natus_typedefs( euler_angles<double_t>, euler_anglesd ) ;
    }
}