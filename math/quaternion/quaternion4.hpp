...
namespace natus
{
    namespace math
    {
        ...
        class quaternion4
        {
            natus_this_typedefs( quaternion4<T> ) ;
            ...
            natus_typedefs( natus::math::quaternion3<T>, quat3 ) ;
        ...
        natus_typedefs( quaternion4<float_t>, quat4f ) ;
        natus_typedefs( quaternion4<double_t>, quat4d ) ;
    }
}