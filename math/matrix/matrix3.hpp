...
namespace natus
{
    namespace math
    {
        ...
        public: // typedefs 
            ...
            natus_this_typedefs( matrix3<T> ) ;

            natus_typedefs( T, type ) ;
            natus_typedefs( matrix4<T>, mat4 ) ;
            natus_typedefs( vector3<T>, vec3 ) ;
            natus_typedefs( vector4<T>, vec4 ) ;
            natus_typedefs( quaternion4<T>, quat4 ) ;
        ...
        public: // common
            ...
            */
            ...
            type_t angle( void ) const {
                return natus::math::fn<type_t>::acos( (this->trace()-type_t(2))*(type_t(0.5)) ) ;
            }
        ...
        natus_typedefs( matrix3<int_t>, mat3i ) ;
        natus_typedefs( matrix3<float_t>, mat3f ) ;
        natus_typedefs( matrix3<double_t>, mat3d ) ;
        natus_typedefs( matrix3<uint_t>, mat3ui ) ;
        natus_typedefs( matrix3<size_t>, mat3s ) ;
    }
}
