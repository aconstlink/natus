...
namespace natus
{
    namespace math
    {
        ...
        class matrix4
        {
            natus_this_typedefs( matrix4<T> ) ;

            natus_typedefs( T, type ) ;
            natus_typedefs( natus::math::vector3<T>, vec3 ) ;
            natus_typedefs( natus::math::vector4<T>, vec4 ) ;
            natus_typedefs( natus::math::matrix3<T>, mat3 ) ;
            natus_typedefs( natus::math::matrix4<T>, mat4 ) ;
        ...
        public: // ctor
            ...
            matrix4( natus::math::so_matrix::xyzw )
                : matrix4( natus::math::so_matrix::with_identity() )
            {}

            matrix4( natus::math::so_matrix::xzyw )
            {
                for( size_t i = 0; i<16; ++i )
                    _elem[i] = type_t(0) ;
        ...
        natus_typedefs( matrix4<int_t>, mat4i ) ;
        natus_typedefs( matrix4<float_t>, mat4f ) ;
        natus_typedefs( matrix4<double_t>, mat4d ) ;
        natus_typedefs( matrix4<uint_t>, mat4ui ) ;
        natus_typedefs( matrix4<size_t>, mat4s ) ;
    }
} 