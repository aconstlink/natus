...
namespace natus
{
    namespace math
    {
        namespace m2d
        {
            ...
            {
                natus_this_typedefs( coord_transformator< real_t > ) ;

                natus_typedefs( natus::math::vector2<real_t>, vec2r ) ;
            ...
            natus_typedefs( coord_transformator< float_t >, coord_transformatorf ) ;
        }
    }
}