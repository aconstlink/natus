    ...
    namespace math
    {
        namespace m2d
        {
            ...
            public:
                ...
                template< typename type_t >
                natus::math::vector2< type_t > get_width_height( void_t ) const
                {
                    return natus::math::vector2< type_t >( type_t( _width ), type_t( _height ) ) ;
                }

                template< typename type_t >
                natus::math::vector2< type_t > get_xy( void_t ) const
                {
                    return natus::math::vector2< type_t >( type_t( _x ), type_t( _y ) ) ;
                }

                template< typename type_t >
                natus::math::vector4< type_t > get_as_vec4( void_t ) const
                {
                    return natus::math::vector4< type_t >( type_t( _x ), type_t( _y ), type_t( _width ), type_t( _height ) ) ;
                }
            } ;
        }
    }
    natus_typedefs( natus::math::m2d::viewport, viewport_2d ) ;
}