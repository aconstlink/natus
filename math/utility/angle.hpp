...
namespace natus
{
    namespace math
    {
        ...
        public:
            ...
            {
                return natus::math::fn<type_t>::mod( radian, type_t( 2 ) * natus::math::constants<type_t>::pi() ) ;
            }

            static type_t radian_to_degree( type_t const radian )
            {
                return radian * type_t( 180 ) / natus::math::constants<type_t>::pi() ;
            }
