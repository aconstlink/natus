    ...
    namespace math
    {
        namespace m3d
        {
            ...
            void translate_camera_matrix_to( 
                natus::math::vector3< type_t > const &pos,
                natus::math::matrix4< type_t > & inout ) 
            {
            ...
            void create_lookat_from_vec( 
                natus::math::vector3< type_t > const &pos, 
                natus::math::vector3< type_t > const &dir, 
                natus::math::vector3< type_t > const &up, 
                natus::math::vector3< type_t > const &right,
                natus::math::matrix4< type_t > & inout ) 
            {
                typedef natus::math::vector4< type_t > vec4_t ;
            ...
            void get_frame_from_camera_matrix( 
                natus::math::vector3< type_t > & pos, 
                natus::math::vector3< type_t > & dir, 
                natus::math::vector3< type_t > & up, 
                natus::math::vector3< type_t > & right,
            ...
            void set_pos_for_camera_matrix( 
                natus::math::vector3< type_t > const & pos,
                natus::math::matrix4< type_t > & mat_inout ) 
            {
            ...
            */
            ...
            void create_lookat_rh( 
                natus::math::vector3< type_t > const &vcPos,
                natus::math::vector3< type_t > const &vcUp,
                natus::math::vector3< type_t > const &vcAt, 
                natus::math::matrix4< type_t > & inout ) 
            {
            ...
            */
            ...
            void create_lookat_rh_from_dir( 
                natus::math::vector3< type_t > const &vcPos, 
                natus::math::vector3< type_t > const &vcDir, 
                natus::math::matrix4< type_t > & inout ) 
            {
                typedef natus::math::vector3< type_t > vec3_t ;
            ...
            */
            ...
            void create_view_matrix( 
                natus::math::matrix4< type_t > const & cm, 
                natus::math::matrix4< type_t > & out )
            {
                typedef natus::math::matrix3< type_t > mat3_t ;
                typedef natus::math::matrix4< type_t > mat4_t ;
                typedef natus::math::vector3< type_t > vec3_t ;
