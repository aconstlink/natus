...
namespace natus
{
    namespace math
    {
        ...
        {
            natus_this_typedefs( keyframe_sequence<T> ) ;

        public:

            natus_typedefs( T, spline ) ;
            natus_typedefs( typename T::value_t, value ) ;
            natus_typedefs( keyframe<value_t>, keyframe ) ;
            natus_typedefs( natus::ntd::vector< keyframe_t >, keyframes ) ;
            natus_typedefs( natus::ntd::vector< size_t >, time_stamps ) ;
