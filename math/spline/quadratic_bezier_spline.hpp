...
namespace natus
{
    namespace math
    {
        ...
        {
            natus_this_typedefs( quadratic_bezier_spline<T> ) ;
        ...
        public:
            ...
            quadratic_bezier_spline( natus::ntd::vector< value_t > const & li, this_t::init_type t = this_t::init_type::complete ) noexcept
            {
                if( li.size() < 3 ) return ;
            ...
            quadratic_bezier_spline( std::initializer_list< value_t > const & li, this_t::init_type t = this_t::init_type::complete ) noexcept :
                quadratic_bezier_spline( natus::ntd::vector< value_t >( li), t )
            {
        ...
        natus_typedefs( quadratic_bezier_spline<float_t>, quadratic_bezier_splinef ) ;
    }
}