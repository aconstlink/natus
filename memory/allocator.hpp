...
namespace natus
{
    namespace memory
    {
        template< typename T, typename mem_t = natus::memory::global >
        class allocator
        {
        public:
            ...
            natus::memory::purpose_t _purpose = "[natus::memory] : allocator" ;
        ...
        public:
            ...
            allocator( natus::memory::purpose_cref_t purpose ) throw( ) : _purpose( purpose ) {}
