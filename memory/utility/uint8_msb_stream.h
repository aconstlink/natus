    ...
    namespace memory
    {
        namespace utility
        {
            ...
            public:
                ...
                {
                    natus::memory::natus_utility::uint8_msb_split::of( n, &_array[ _cur_pos ] ) ;
                    _cur_pos += 2 ;
                    return *this ;
                }
            ...
            public:
                ...
                this_ref_t operator >> ( uint16_t& n )
                {
                    n = natus::memory::natus_utility::uint8_msb_merge::uint16( &_array[ _cur_pos ] ) ;
                    _cur_pos += 2 ;
                    return *this ;
                }
                ...
                this_ref_t operator >> ( uint32_t& n )
                {
                    n = natus::memory::natus_utility::uint8_msb_merge::uint32( &_array[ _cur_pos ] ) ;
                    _cur_pos += 4 ;
                    return *this ;
                }
                ...
                this_ref_t operator >> ( uint64_t& n )
                {
                    n = natus::memory::natus_utility::uint8_msb_merge::uint64( &_array[ _cur_pos ] ) ;
                    _cur_pos += 8 ;
                    return *this ;
                }
            };
