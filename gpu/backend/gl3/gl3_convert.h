...
namespace natus
{
    namespace gpu
    {
        ...
        namespace gl3
        {
            ...
            {
                return natus::gpu::gl3::detail::filter_modes_gl[ ( size_t ) m ] ;
            }

            static GLenum convert( texture_filter_type const t ) noexcept
            {
                return natus::gpu::gl3::detail::filter_types_gl[ ( size_t ) t ] ;
            }
            ...
            static GLenum convert( texture_wrap_mode const m ) noexcept {
                return natus::gpu::gl3::detail::wrap_modes_gl[ ( size_t ) m ] ;
            }

            static GLenum convert( texture_wrap_type const t ) noexcept {
                return natus::gpu::gl3::detail::wrap_types_gl[ ( size_t ) t ] ;
            }
        }
    }
}