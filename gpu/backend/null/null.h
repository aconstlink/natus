...
namespace natus
{
    namespace gpu
    {
        ...
        public:
            ...
            virtual natus::gpu::id_t configure( id_rref_t id, natus::gpu::render_configuration_res_t ) noexcept override ;
            ...
            virtual natus::gpu::id_t render( id_rref_t id, natus::gpu::backend::render_detail_cref_t ) noexcept override ;
