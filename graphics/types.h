...
namespace natus
{
    ...
    namespace graphics
    {
        ...
        static size_t size_of( natus::graphics::image_format const imf )
        {
            switch( imf )
            {
            case natus::graphics::image_format::rgb: return 3 ;
            case natus::graphics::image_format::rgba: return 4 ;
            default: break ;
            }
            return 0 ;
        }
        ...
        static size_t size_of( natus::graphics::image_element_type const iet )
        {
            switch( iet )
            {
            case natus::graphics::image_element_type::float8: return 1 ;
            case natus::graphics::image_element_type::float16: return 2 ;
            case natus::graphics::image_element_type::float32: return 4 ;

            case natus::graphics::image_element_type::int8: return 1 ;
            case natus::graphics::image_element_type::int16: return 2 ;
            case natus::graphics::image_element_type::int32: return 4 ;

            case natus::graphics::image_element_type::uint8: return 1 ;
            case natus::graphics::image_element_type::uint16: return 2 ;
            case natus::graphics::image_element_type::uint32: return 4 ;
