...
namespace natus
{
    namespace graphics
    {
        ...
        private:
            ...
            natus::graphics::shader_t _vs ;
            natus::graphics::shader_t _ps ;
            natus::graphics::shader_t _gs ;
        ...
        public:
            ...
            this_ref_t set_vertex_shader( natus::graphics::shader_in_t s ) noexcept
            {
                _vs = s ;
                return *this ;
            }

            this_ref_t set_pixel_shader( natus::graphics::shader_t s ) noexcept
            {
                _ps = s ;
                return *this ;
            }

            this_ref_t set_geometry_shader( natus::graphics::shader_t s ) noexcept
            {
                _gs = s ;
                return *this ;
            }

            natus::graphics::shader_cref_t vertex_shader( void_t ) const noexcept
            {
                return _vs ;
            }

            natus::graphics::shader_cref_t pixel_shader( void_t ) const noexcept
            {
                return _ps ;
            }

            natus::graphics::shader_cref_t geometry_shader( void_t ) const noexcept
            {
                return _gs ;
            }
