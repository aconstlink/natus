...
struct gl3_backend::pimpl
{
    ...
    typedef natus::ntd::vector< this_file::shader_config > shaders_t ;
    shaders_t shaders ;

    typedef natus::ntd::vector< this_file::render_config > rconfigs_t ;
    rconfigs_t rconfigs ;

    typedef natus::ntd::vector< this_file::geo_config > geo_configs_t ;
    geo_configs_t geo_configs ;

    typedef natus::ntd::vector< this_file::image_config > image_configs_t ;
    ...
    bool_t connect( this_file::render_config & config, natus::graphics::variable_set_res_t vs )
    {
        auto item_data = ::std::make_pair( vs,
            natus::ntd::vector< this_file::render_config::uniform_variable_link >() ) ;

        auto item_tex = ::std::make_pair( vs,
            natus::ntd::vector< this_file::render_config::uniform_texture_link >() ) ;
    ...
    void_t set_render_states( natus::graphics::render_state_sets_in_t rs ) 
    {
        if( render_states.blend_s.do_blend != rs.blend_s.do_blend )
        {
            if( rs.blend_s.do_blend )
            {
                ...
                GLenum const glsrc = natus::graphics::gl3::convert( rs.blend_s.src_blend_factor ) ;
                GLenum const gldst = natus::graphics::gl3::convert( rs.blend_s.dst_blend_factor ) ;
...
//****
gl3_backend::gl3_backend( void_t ) noexcept : backend( natus::graphics::backend_type::gl3 )
{
...
//****
natus::graphics::result gl3_backend::configure( natus::graphics::geometry_configuration_res_t gconf ) noexcept 
{
...
//****
natus::graphics::result gl3_backend::configure( natus::graphics::render_configuration_res_t config ) noexcept 
{
...
//***
natus::graphics::result gl3_backend::configure( natus::graphics::shader_configuration_res_t config ) noexcept
{
    natus::graphics::id_res_t id = config->get_id() ;
...
//***
natus::graphics::result gl3_backend::configure( natus::graphics::image_configuration_res_t config ) noexcept 
{
    natus::graphics::id_res_t id = config->get_id() ;
...
//***
natus::graphics::result gl3_backend::connect( natus::graphics::render_configuration_res_t config, natus::graphics::variable_set_res_t vs ) noexcept
{
    natus::graphics::id_res_t id = config->get_id() ;
...
//****
natus::graphics::result gl3_backend::update( natus::graphics::geometry_configuration_res_t config ) noexcept 
{
    natus::graphics::id_res_t id = config->get_id() ;
...
//****
natus::graphics::result gl3_backend::render( natus::graphics::render_configuration_res_t config, natus::graphics::backend::render_detail_cref_t detail ) noexcept 
{ 
    natus::graphics::id_res_t id = config->get_id() ;
